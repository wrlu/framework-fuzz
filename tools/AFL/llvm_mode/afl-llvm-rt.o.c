...
/* Puzzor Coverage recovery support for __sanitizer_cov_trace_pc_guard  start*/

#define MAX_BBS_COUNT  100000
// Overall Map of the BBs
uint32_t BBS_MAP[MAX_BBS_COUNT]={0};
// how many BBs have been counted;
uint32_t BBS_COUNT=0;

/* Puzzor Coverage recovery support for __sanitizer_cov_trace_pc_guard  ends*/
